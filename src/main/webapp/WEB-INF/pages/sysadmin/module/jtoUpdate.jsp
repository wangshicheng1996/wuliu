...
<table id="ec_table" class="tableRegion" width="98%" >
	...
	<tr class="odd">
		...
		<td>
			<select name="parentModule.moduleId" style="width:121px">
				<c:forEach items="${allModule}" var="a">
				<c:if test="${mudule.moduleId !=a.moduleId }"><option value="${a.moduleId}">${a.name}</option></c:if>
				</c:forEach>
			</select>
		</td>
	</tr>
	...
	<tr class="odd">
		<td>备注信息:</td>
		<td>
			<textarea style="height:130px;width:100%" name="remark">${module.remark }</textarea>
		</td>
	</tr>
</table>
</div>
